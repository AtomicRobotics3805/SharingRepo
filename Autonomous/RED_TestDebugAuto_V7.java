...
@Autonomous(name = "RED Logging")
//@Disabled
public class RED_TestDebugAuto_V7 extends OpMode {
    private String debugFilePath = Environment.getExternalStorageDirectory().getPath() + "/LogRED.txt";
    ...
    private double[][] movementArray = new double[][]{
           //_,______,______}
            ...
            {5,     1,    24}, //Slide over to move the light sensor away from the line
    ...
    private int preMainProgramStep = 0;
    private int preScoreBeaconsStep = 0;
    private int preShootStep = 0;
