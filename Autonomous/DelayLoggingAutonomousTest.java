...
@Autonomous(name = "Delayed shoot only logging")
//@Disabled
public class DelayLoggingAutonomousTest extends OpMode {
    private String debugFilePath = Environment.getExternalStorageDirectory().getPath() + "/LogShootOnly.txt";
    ...
    public void init_loop() {
        ...
        debugLogFile.write("delayValue, knockCap", delayValue + ", " + knockCapBall);
    ...
    public void loop() {
        ...
        debugLogFile.write("States: main, shoot", mainProgramStep + ", " + shootStep);
