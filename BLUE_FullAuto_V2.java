...
//@Disabled
public class BLUE_FullAuto_V2 extends OpMode {
            ...
            case 3: //TODO Score far beacon
                switch (beaconStep) {
                    ...
                    case 1: //Move to far beacon line
                        if (PIDNavigator.wheelEncoderValue() >= baseEncoderTicks + PIDNavigator.encoderCountFromInches(26)) {
                            beaconStep++;
                        } else {
                            robot.wallFollowLeft(0.2, 9.75, 0.06, 0.00001, 0);
                            telemetry.addData(">>", "Driving 26 inches");
                        }
                        break;
                ...
                switch (beaconStep) {
                    ...
                    case 1: //Move to far beacon line
                        if (PIDNavigator.wheelEncoderValue() <= baseEncoderTicks - PIDNavigator.encoderCountFromInches(30)) {
                            ...
                            //robot.wallFollowLeft(-0.2, 10.5, 0.1, 0, 0);
                            PIDNavigator.moveNoStop(-0.2);
